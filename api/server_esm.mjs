...
const ownersService = new OwnersService(pool);
const propertiesService = new PropertiesService(pool);
const invoicesService = new InvoicesService(pool, ownersService);
