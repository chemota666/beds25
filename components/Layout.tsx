    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <aside className="w-64 bg-white border-r border-gray-200 hidden md:flex flex-col p-6 fixed inset-y-0">
        <div className="mb-10 px-2 flex items-center space-x-2">
          ...
          <h1 className="text-xl font-bold text-gray-800">RoomFlow</h1>
        </div>
        ...
        <nav className="flex-1 space-y-2">
          ...
          <SidebarLink 
            to="/debtors" 
            label="Deudores" 
            icon={<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>} 
          />
        </nav>
