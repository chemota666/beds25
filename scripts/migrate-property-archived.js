...
const migrate = async () => {
  ...
  try {
    console.log('Starting property archived migration...');
    ...
    try {
      ...
      `);
      console.log('✓ Added archived column to properties');
    } catch (err) {
      if (err.message && err.message.includes('Duplicate column')) {
        console.log('✓ archived column already exists in properties');
      } else {
        throw err;
      }
    }
